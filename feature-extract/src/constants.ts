...
export const output_feature_path = join(getRootDirectory(), 'output_feature');

export const ant_data_set_path = '/Volumes/data1/code/school/graduate-design/data-set/packages/malicious/npm_malicious_package';